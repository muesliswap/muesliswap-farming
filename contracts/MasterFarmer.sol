...
// MasterFarmer is the master of Milk AND MilkSPLIT. 
// He can make Milk and he is a fair guy.
//
...
contract MasterFarmer is Ownable {
    ...
    struct PoolInfo {
        ...
        uint256 accCakePerShare; // Accumulated Milks per share, times 1e12. See below.
    }
    ...
    // Deposit LP tokens to MasterFarmer for Milk allocation.
    ...
    // Stake Milk tokens to MasterFarmer
    ...
    // Safe cake transfer function, just in case if rounding error causes pool to not have enough Milks.
